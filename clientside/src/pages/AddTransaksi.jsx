...
export const AddTransaksi = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setIsLoading(true);
      await axiosClient.post(`transaksi`, {
        Stok: stok,
  ...
  return (
    <div className="fixed z-40 py-72 inset-16 mt-10 px-5 flex items-center justify-center bg-opacity-50 transition-opacity duration-300 ease-in-out">
      <div className=" relative pt-5 bg-white px-4 sm:px-6 md:px-8 py-16 rounded-xl max-w-lg w-full">
